...
The Reward Provider provides rewards based on the performances of the portfolio and investor preference. We first introduce a reward equal to the profit p, with , penalty upon negative profits exceeding the given absolute value threshold \(\theta\). 
\[
