...
The Reward Provider provides rewards based on the performances of the portfolio and investor preference. We first use profit p as the baseline for the reward and add a penalty upon negative profits exceeding the given absolute value threshold \(\theta\). 
\[
